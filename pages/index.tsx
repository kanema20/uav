        ...
        <Layout>
            <div className="min-h-screen bg-gray-900 text-white">
                <Head>
                    ...
                    <meta name="description" content="Next-generation crypto trading platform with advanced analytics and real-time market data" />
                ...
                <main>
                    ...
                    <section className="relative h-screen flex items-center justify-center overflow-hidden">
                        ...
                        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                            ...
                            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
                                Unlock the power of advanced trading analytics and real-time market insights
                            </p>
                            <Link 
                                href="/app"
                        ...
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                <div className="p-6 bg-gray-700/50 rounded-xl">
                                    ...
                                    <p className="text-gray-300">Real-time market data and predictive analytics to help you make informed trading decisions.</p>
                                </div>
                                <div className="p-6 bg-gray-700/50 rounded-xl">
                                    ...
                                    <p className="text-gray-300">Execute trades in milliseconds with our high-performance trading engine.</p>
                                </div>
                                <div className="p-6 bg-gray-700/50 rounded-xl">
                                    ...
                                    <p className="text-gray-300">Bank-grade security with multi-factor authentication and cold storage options.</p>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="py-20 bg-gradient-to-r from-purple-900/50 to-blue-900/50">
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                            ...
                            <p className="text-xl text-gray-300 mb-8">Join thousands of traders who trust Crypto Alpha for their trading needs.</p>
                            <Link 
                                href="/app"
