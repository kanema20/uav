...
export default function UAVPage() {
  ...
  useEffect(() => {
    const stopStreaming = streamTransactions((transaction) => {
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col items-center justify-center mb-12">
          ...
          <p className="text-xl text-gray-400 mt-3 text-center">Real-time trench signals</p>
        </div>
        ...
        {isFilterOpen && (
          <div className="mb-6 p-6 rounded-xl bg-gray-900 border border-gray-800">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-2">Min Amount (SOL)</label>
                <input
                  type="number"
                  name="minAmount"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-2">Max Amount (SOL)</label>
                <input
                  type="number"
                  name="maxAmount"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-2">Min Market Cap (M)</label>
                <input
                  type="number"
                  name="minMarketCap"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-400 mb-2">Max Market Cap (M)</label>
                <input
                  type="number"
                  name="maxMarketCap"
          ...
          <div className="divide-y divide-gray-800">
            {transactions.length === 0 ? (
              <div className="p-6 text-center text-gray-400">
                No transactions found. Adjust your filters or wait for new transactions.
              </div>
            ) : (
