...
export const getSolanaConnection = () => {
    const rpcUrl =
        'https://mainnet.helius-rpc.com/?api-key=1536e743-4498-496e-beab-9f7ca88233d0';
    if (!rpcUrl) {
...
export const isTokenPurchaseTransaction = (
...
export const estimateTransactionSolValue = (
    transaction: ParsedTransactionWithMeta | null,
): number => {
...
export const extractTokenSymbol = async (
    transaction: ParsedTransactionWithMeta | null,
): Promise<string> => {
    if (!transaction) {
        return 'UNKNOWN';
